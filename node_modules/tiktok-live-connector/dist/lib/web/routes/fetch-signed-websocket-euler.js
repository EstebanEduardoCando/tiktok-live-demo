...
const euler_api_sdk_1 = require("@eulerstream/euler-api-sdk");
class FetchSignedWebSocketFromEulerRoute extends route_1.Route {
    async call({ roomId, uniqueId, sessionId, ttTargetIdc, useMobile }) {
        ...
        try {
            ...
            true, undefined, useMobile ? euler_api_sdk_1.WebcastFetchPlatform.Mobile : euler_api_sdk_1.WebcastFetchPlatform.Web, {
